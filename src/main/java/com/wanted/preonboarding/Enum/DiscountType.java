...
import com.wanted.preonboarding.util.discount.concrete.FixedAmountDiscountCalculator;
import com.wanted.preonboarding.util.discount.concrete.PercentageDiscountCalculator;
...
public enum DiscountType {
    ...
    PER_TEN_TIMES(new PercentageDiscountCalculator(BigDecimal.valueOf(0.1)), "10번마다 10퍼센트 할인"); // 10번 결제마다 10퍼센트 할인
